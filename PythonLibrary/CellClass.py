...
'TBOXA': \
   {'x':58,\
    ...
    'safeDepth':universalSafeHeight,\
    'maxDepth': None,\
    'tipAttachDepth': UniversalTipAttachDepth + 0,\
    'ejectDepth': None,\
    'wellDist': wellDist, \
    'deepWellOffset':False,\
   'readdress':{'UL':[0, 0],'UR': [1, 0], 'LL':[0, 1], 'LR':[1, 1]}},\
...
'TBOXC': \
   {'x':20,\
    ...
    'safeDepth':universalSafeHeight,\
    'maxDepth': None,\
    'tipAttachDepth': UniversalTipAttachDepth + 25,\
    'ejectDepth': None,\
    'wellDist': wellDist, \
    'deepWellOffset':False,\
    'readdress':{'UL':[0, 0],'UR': [1, 0], 'LL':[0, 1], 'LR':[1, 1]}},\
...
XPositions =                   [[125, 5683, 11670, 16960, 22232, 27518, 32795, 38085, 43385, 48680],
								[125, 5683, 11680, 16975, 22242, 27513, 32805, 38085, 43370, 48625],
								[125, 5683, 11670, 16950, 22222, 27508, 32780, 38065, 43360, 48600],
								[125, 5683, 11650, 16940, 22227, 27503, 32805, 38065, 43335, 48630]]
