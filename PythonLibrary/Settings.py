...
STDtipAttach = 16350 #standard depth to seat tips (dont go too low)
STDtipSeat = 16350 #standard depth to seat tips (dont go too low)
...
#Air buffer (extra air that is aspirated for safety and sample retention)
# in theory 2.5 ul
airBuffer = 10
